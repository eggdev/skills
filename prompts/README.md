...
| [proposal-to-plan](proposal-to-plan/PROMPT.md) | In-project loop converting adopt-verdict assessments into implementation plans (steps, verification, rollback, launch line); records to shared ledger | project_name (req), ledger_db, plans_dir | v1 |
